...
base_image_url=${base_image_url:-http://resources.ovirt.org/releases/node-base/nightly/iso/ovirt-node-iso-3.0.3-1.1.fc19.iso}
buildnumber=${buildnumber:-1}
proxy_repo=${proxy_repo:-http://yum.theforeman.org/nightly/f19/\$basearch}
...
VERSION=$(grep AC_INIT foreman_discovery/extra/ovirt-node-plugin-foreman/configure.ac | grep -oE '[0-9].[0-9].[0-0]')-$buildnumber

wget -nc -c "$base_image_url"
